...
function () {
  ...
  __decorate([graphql_1.Query(function () {
    return [user_entity_1.User];
  }, {
    name: 'users'
  }), auth_decorator_1.Auth(auth_type_enum_1.AuthType.Bearer)], UsersResolver.prototype, "findAll");

  __decorate([graphql_1.Query(function () {
    return user_entity_1.User;
  }, {
    name: 'me'
  }), __param(0, current_user_decorator_1.CurrentUser())], UsersResolver.prototype, "findOne");

  __decorate([graphql_1.Query(function () {
    return user_entity_1.User;
  }, {
    name: 'username'
  }), __param(0, graphql_1.Args('FindUserInput'))], UsersResolver.prototype, "findOneByUsername");

  __decorate([graphql_1.Mutation(function () {
    return user_entity_1.User;
  }), __param(0, current_user_decorator_1.CurrentUser()), __param(1, graphql_1.Args('updateUserInput')), __param(2, graphql_1.Args('uploadUserImagesInputDto'))], UsersResolver.prototype, "updateUser");
  ...
  UsersResolver = __decorate([graphql_1.Resolver(function () {
    return user_entity_1.User;
  })], UsersResolver);
