...
var FindOneByEmailProvider = /** @class */ (function () {
    function FindOneByEmailProvider(usersRepository) {
        this.usersRepository = usersRepository;
    }
    FindOneByEmailProvider.prototype.findOneByEmail = function (email) {
    ...
    FindOneByEmailProvider = __decorate([
        common_1.Injectable(),
        __param(0, typeorm_1.InjectRepository(user_entity_1.User))
    ], FindOneByEmailProvider);
    return FindOneByEmailProvider;
}());
