...
var RolesGuard = /** @class */ (function () {
    function RolesGuard(reflector, authService) {
        this.reflector = reflector;
        this.authService = authService;
    }
    RolesGuard.prototype.canActivate = function (context) {
        return __awaiter(this, void 0, Promise, function () {
            var requiredRoles, gqlContext, req, payload, user, hasRequiredRoles;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.authService.validateRoleUser(payload.email)];
                    case 1:
                        user = _a.sent();
                        if (!user) {
                            throw new common_1.ForbiddenException('User not found');
                        }
                        hasRequiredRoles = requiredRoles.some(function (role) { return user.role === role; });
